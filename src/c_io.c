...
int		c_height = 50;		// 50 FOR STRIFE (100 FOR DOOM)
...
*/
	M_WriteText(0, current_height - 10, tempstr2);

	if(leveltime & 16)
	    M_WriteText(16, current_height - 10, tempstr);
	else
	    M_WriteText(272, current_height - 10, tempstr);
    }
}
